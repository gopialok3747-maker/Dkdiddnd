...
New Dashboard Style | Desi | Fast (httpx + asyncio)
"""
...
PANELS_PATH = BASE_DIR / "data" / "panels.json"
DB_PATH = BASE_DIR / "data" / "monitor.db"
STATUS_PATH = BASE_DIR / "data" / "monitor_status.json"
APPROVAL_FILE = BASE_DIR / "data" / "approved_users.json"
PENDING_FILE = BASE_DIR / "data" / "pending_users.json"
CHAT_STATE_FILE = BASE_DIR / "data" / "chat_state.json"
